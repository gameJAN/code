...
public class Article implements Serializable {
    ...
    private boolean isUseful=true;//是否有效
    ...
    public String getGetContentNoTag() {
        return getContentNoTag;
    }

    public void setGetContentNoTag(String getContentNoTag) {
        this.getContentNoTag = getContentNoTag;
    }
